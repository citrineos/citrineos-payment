...
class PricingTests(unittest.TestCase):  # TODO: negative costs scenarios?
    def test_total_costs_net(self):
        for pricing, expected_total_costs_net in [
            ...
            with self.subTest(
                energy_costs=pricing.energy_costs,
                time_costs=pricing.time_costs,
                session_costs=pricing.session_costs,
    ...
    def test_tax_costs(self):
        for pricing, expected_tax_costs in [
            (
                a_pricing(energy_costs=0, time_costs=0, session_costs=0, tax_rate=23),
                0,
            ),  # 0
            (
                a_pricing(
                    energy_costs=1494, time_costs=0, session_costs=0, tax_rate=23
                ),
                343,
            ),  # 3.4362
            (
                a_pricing(energy_costs=0, time_costs=891, session_costs=0, tax_rate=23),
                204,
            ),  # 2.0493
            (
                a_pricing(energy_costs=0, time_costs=0, session_costs=100, tax_rate=23),
                23,
            ),  # 0.23
            (
                a_pricing(
                    energy_costs=1494, time_costs=891, session_costs=100, tax_rate=0
                ),
                0,
            ),  # 0
            (
                a_pricing(
                    energy_costs=1494, time_costs=891, session_costs=100, tax_rate=8
                ),
                198,
            ),  # 1.988
            (
                a_pricing(
                    energy_costs=1494, time_costs=891, session_costs=100, tax_rate=23
                ),
                571,
            ),  # 5.7155
            (
                a_pricing(
                    energy_costs=1494, time_costs=891, session_costs=100, tax_rate=50
                ),
                1242,
            ),  # 12.425
            (
                a_pricing(
                    energy_costs=1494, time_costs=891, session_costs=100, tax_rate=100
                ),
                2485,
            ),  # 24.85
        ]:
